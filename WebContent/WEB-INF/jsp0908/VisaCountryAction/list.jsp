...
<div class="am-panel-hd">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
       <form class="am-form" action="${basePath}background/VisaCountryAction.do?method=list" method="post">
		...
		<html:hidden property="pageSize" value="10"/>
          <table class="am-table am-table-striped am-table-hover table-main">
             ...
             <tr class="TableDetail1 template"><td>${item.key.name}&nbsp;</td>  <td>${item.key.description}&nbsp;</td>   <td>${item.key.icon}</td> <td>
           		<html:link action="background/VisaCountryAction?method=editUI&id=${item.key.id}">修改</html:link>
           		<html:link action="background/VisaCountryAction?method=delete&id=${item.key.id}" onclick="return delConfirm()">删除</html:link>
           	</td></tr>
             <c:forEach items="${item.value}" var="country">
