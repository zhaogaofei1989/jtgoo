...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">签证订单</strong> / <small>签证订单查看</small></div>
  </div>
      ...
      <div class="am-tab-panel am-fade am-form" id="tab">
    	...
    	<input type="hidden" id="userType" value="${customer_userType }"/>
           ...
           <style type="text/css">
				            ...
				            #search_divvisa_id li a:hover, #search_divvisa_id li:hover{ background-color:#e2eaff}
				             ...
				             <div class="content_div">
				                        <html:text disabled="true" styleId="name" property="name" onfocus="if(this.value == this.defaultValue) this.value = ''" onblur="if(this.value.replace(' ','') == '') this.value = this.defaultValue;"/>
          ...
          <div class="am-g am-margin-top">
           ...
           用户类型
            ...
            <div class="am-u-sm-8 am-u-md-4">
					                       同业用户
					                       <html:radio disabled="true" property="customer_userType" styleId="tradeUser" value="0" onclick="alter(this.value)"  style="width:60px;"/>
					                       直接用户<html:radio disabled="true" property="customer_userType" styleId="directUser"  value="1" onclick="alter(this.value)" style="width:60px;"/> 
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          </div>
          <div class="am-g am-margin-top" id="cus_1">
            ...
            <style type="text/css">
												            ...
												            #search_div_customService_id li a:hover, #search_div_customService_id li:hover{ background-color:#e2eaff}
											                       ...
											                       <div id="userNameDiv"> 
											                       <html:text disabled="true" property="tradeUserForm" onfocus="if(this.value == this.defaultValue) this.value = ''" onblur="if(this.value.replace(' ','') == '') this.value = this.defaultValue;" styleId="userName" styleClass="InputStyle"/> 
											           ...
											           联系人:
											            <select disabled="true" name="customerServicerId" id="customerServicerId">
          ...
          <div class="am-g am-margin-top" id="cus_2">
           ...
           <style>
					                        ...
					                        <html:text disabled="true" property="directUserForm" onfocus="if(this.value == this.defaultValue) this.value = ''" onblur="if(this.value.replace(' ','') == '') this.value = this.defaultValue;" styleId="customername" styleClass="InputStyle"/> 
            ...
            <div class="am-u-sm-8 am-u-md-4">
              <select disabled="true" name="single" id="single" >
                        <option selected="selected" value="">请选择</option>
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:textarea disabled="true" styleClass="TextareaStyle" property="supplementData"/>
                			      <br/><br/>
		  ...
		  <span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <select disabled="true" name="operator" id="operator" class="SelectStyleSecond">
                        <option selected="selected" value="">请选择</option>
                         <c:forEach var="user" items="${userList }">  
            ...
            <div class="am-u-sm-8 am-u-md-4">
              <div id="d1">已补充资料一: <html:text disabled="true" property="data1" styleClass="InputStyle"/>
                <br/>   
                   <div class="am-input-group date form_datetime-3">
		  ...
		  <span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
                        ...
                        <div id="d2">已补充资料二: <html:text disabled="true" property="data2" styleClass="InputStyle"/>
                        <br/>   
                   <div class="am-input-group date form_datetime-3">
			  ...
			  <span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
                        ...
                        <div id="d3">已补充资料三: <html:text disabled="true" property="data3" styleClass="InputStyle"/>    
                        <br/>   
                          <div class="am-input-group date form_datetime-3">
			  ...
			  <span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
                        ...
                        <div id="d4">已补充资料四: <html:text disabled="true" property="data4" styleClass="InputStyle"/> 
                        <br/>   
                         <div class="am-input-group date form_datetime-3">
			  ...
			  <span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
                        ...
                        <div id="d5">已补充资料五: <html:text disabled="true" property="data5" styleClass="InputStyle"/>  
                        <br/>
                           <div class="am-input-group date form_datetime-3">
            ...
            <div class="am-u-sm-8 am-u-md-4">
                  否:<html:radio disabled="true" property="dataIsComplete"  value="0"/> 是:<html:radio disabled="true" property="dataIsComplete" value="1"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
            ...
            <div class="am-u-sm-8 am-u-md-4">
                 <select disabled="true" name="sentToSignPeople" id="sentToSignPeople" class="SelectStyleSecond">
                        <option selected="selected" value="">请选择</option>
                         <c:forEach var="user" items="${userList }">  
            ...
            <div class="am-u-sm-8 am-u-md-4">
              单次:<html:radio property="oneToManySelect" disabled="true"  value="0"/> 多次:<html:radio disabled="true" property="oneToManySelect" value="1"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
       	   <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
               是: <html:radio disabled="true" property="buyInsurance"  value="0"/> 否:<html:radio disabled="true" property="buyInsurance" value="1"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:textarea disabled="true" styleClass="TextareaStyle" property="insuranceRemarks"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
        ...
        <c:forEach items="${cusDatList}" var="cusDat">
           ...
           <label style="font-weight:bolder;" onclick='showCustomerName(${visaProductId},${cusDat.customerId})'>${cusDat.customerName}</label>&nbsp;
		            ...
		            <div class="am-u-sm-8 am-u-md-4">
		             <select disabled="true" name="visaResult[${cusDat.id }]">
					<c:choose>
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <select disabled="true" name="passportReturnMethod" id="passportReturnMethod" onchange="changeMethod(this.value)" class="SelectStyleSecond">
           ...
           领取人:
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="receiver" property="receiver" />
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="receiverPhone" property="receiverPhone" /> 
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
            ...
            <div class="am-u-sm-8 am-u-md-4">
                <div class="am-input-group date form_datetime-3">
			  <html:text disabled="true" property="passportGetTime" styleClass="am-form-field" readonly="true"/>
			  <span class="am-input-group-label add-on"><i class="icon-remove am-icon-close"></i></span>
			  <span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
				</div>
            </div>
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="expressMethod" property="expressMethod" styleClass="InputStyle"/> 
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
             <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="express" property="express" styleClass="InputStyle"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
             <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="expressContact" property="expressContact" styleClass="InputStyle"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
             <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="expressContactInformation" property="expressContactInformation" styleClass="InputStyle"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
             <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text disabled="true" styleId="expressAddress" property="expressAddress" styleClass="InputStyle"/>
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
          	</div>
              </fieldset>
            ...
            <div class="am-u-sm-8 am-u-md-4">
          	  <input disabled="true" type="button" class="am-btn am-btn-default am-round" value="上传资料" onclick="upload(${param.id })"/>   
    ...
    ok: function()
    {
    	 ...
    	 if(orderId!=="")
    	 {
    	   $.ajax({
			 ...
			 success: function(msg){
			 $("#zipData").html("<a href="+msg.path+">"+msg.name+"</a>");
			 }});
