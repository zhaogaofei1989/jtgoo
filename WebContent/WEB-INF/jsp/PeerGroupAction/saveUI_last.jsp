...
<!--显示表单内容-->
<div id="MainArea">
    <html:form action="/background/PeerGroupAction" styleId="myform">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                  <tr>
                        <td>同业用户组名称</td>
                        <td><html:textarea property="name" styleId="name" styleClass="InputStyle"/> *</td>
                    </tr>
                    <tr>
                        <td>查看领区</td>
                        <td><html:text property="description" styleClass="TextareaStyle"/> *</td>
                    </tr>
                </table>
            </div>
        </div>
