      ...
      <div class="am-tab-panel am-fade" id="tab2">
		...
		<input type="hidden" id="occuHidenId" value="${occuId}"/>
          <div class="am-g am-margin-top">
            ...
            <html:text property="name" styleClass="am-input-sm" styleId="peer-name" /> 
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:textarea rows="10" property="description" styleId="peer-description" styleClass="am-input-sm"/> 
            </div>
            <div class="am-hide-sm-only am-u-md-6">*</div>
          </div>
        </html:form>
...
function saveInfo() {
	if($('#peer-name').val() == '') {
		...
		$('#peer-name').focus();
		return;
	} else if($('#peer-description').val() == '') {
		alert("请输入领区！");
		$('#peer-description').focus();
		return;
	} 
	$("#myform").submit();
}
