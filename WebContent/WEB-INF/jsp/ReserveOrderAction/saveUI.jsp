...
var swfu = '';
		...
		swfu = new SWFUpload({
			...
			post_params:{"SWFUPLOADSESSID":"1393553074","dir":"reserver_attchment","type":"2","userid":"38","siteid":"1","dosubmit":"1","thumb_width":"0","thumb_height":"0","watermark_enable":"1","filetype_post":"gif|jpg|jpeg|png|bmp|docx|doc|pdf","swf_auth_key":"d2a5e4ef977c9e6b7759d75e5be77571","isadmin":"1","groupid":"8"},
...
<!--显示表单内容-->
<div id="MainArea">
    <html:form action="/VisaCountryAction">
            ...
            <div class="ItemBlock">
             ...
             <html:select property="parentId" styleClass="SelectStyle">
                    ...
                    <c:if test="${param.id ne null}">
                       <tr>
                        <td>图片</td>
                        <td><html:text property="icon" styleClass="InputStyle required"/> *</td>
                   	 </tr>
                    </c:if>
