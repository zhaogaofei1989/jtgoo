...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${basePath}/style/images/title_arrow.gif"/> 在职人员所需签证资料1
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <html:form action="/VisaDataTypeDetailAction">fff
