...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">直接用户管理</strong> / <small>${param.id eq null ? '直接用户信息添加' : '直接用户信息修改'}</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
      <div class="am-tab-panel am-fade" id="tab2">
        <html:form styleClass="am-form" styleId="myform" action="background/MemberAction">
		...
		<input type="hidden" id="occuHidenId" value="${occuId}"/>
          <div class="am-g am-margin-top">
            ...
            <html:text property="userName" styleId="direct-userName" styleClass="am-input-sm"/> 
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
            <html:text property="name" styleId="direct-name" styleClass="am-input-sm"/> 
            </div>
            <div class="am-hide-sm-only am-u-md-6">*</div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <html:text styleId="direct-mobliePhone" property="mobliePhone" styleClass="input"/> 
            </div>
            <div class="am-hide-sm-only am-u-md-6">*</div>
          </div>
          <div class="am-g am-margin-top">
		  ...
		  <div class="am-g am-margin-top">
     	  ...
     	  <div class="am-g am-margin-top">
		            ...
		            <div class="am-u-sm-8 am-u-md-4">
		            <html:text property="passwd" styleId="passwd" styleClass="am-input-sm"/>
		            </div>
		            <div class="am-hide-sm-only am-u-md-6"></div>
		  </div>
     	  <div class="am-g am-margin-top">
		            ...
		            <div class="am-u-sm-8 am-u-md-4">
		            <html:text property="confirmPasswd" styleId="confirmPasswd" styleClass="am-input-sm"/>
		            </div>
		            <div class="am-hide-sm-only am-u-md-6"></div>
		  </div>
     	  <div class="am-g am-margin-top">
...
function saveInfo() {
	if($('#direct-userName').val() == '') {
		alert("请输入用户名！");
		$('#direct-userName').focus();
		return;
	} else if($('#direct-name').val() == '') {
		alert("请输入用户姓名！");
		$('#direct-name').focus();
		return;
	} else if($('#direct-mobliePhone').val() == '') {
		alert("请输入联系电话！");
		$('#direct-mobliePhone').focus();
		return;
	} else 	if(!validate()) {
		return;	
	}
