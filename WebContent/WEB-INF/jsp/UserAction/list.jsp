      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
			<iamp-identify:IAMPIdentify authid="01_03_05_00">
          ...
          <tbody>
           ...
           <c:forEach items="${pageBean.recordList}" var="user">
            <tr class="TableDetail1 template">
                ...
                <td>
                	<iamp-identify:IAMPIdentify authid="01_03_04_00">
                		<html:link action="background/UserAction.do?method=delete&id=${user.id}" onclick="return delConfirm()">删除</html:link>
                  	</iamp-identify:IAMPIdentify>
					...
					<html:link action="background/UserAction?method=updatePasswdUI&id=${user.id}">修改密码</html:link>
                </td>
            </tr>
    	    </c:forEach>
          </tbody>
