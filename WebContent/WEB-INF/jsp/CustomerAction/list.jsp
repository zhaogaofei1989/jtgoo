...
<form action="${basePath}background/CustomerAction.do?method=list" method="post">
  <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
    <ul class="am-nav am-nav-pills am-topbar-nav" style="margin: 0 0 10px 20px">
      <li><select name="param" id="param" style="border-style: solid; border-width: 1px; border-color: #999999">
	...
	<option value="chatTools">QQ</option>
      ...
      <li><input id="searchvalue" name="searchvalue" type="text" value=""  style="width:150px; border-style: solid; border-width: 1px; border-color: #999999"/></li>
      <li style="margin-left: 25px">注册时间：<input type="text" name="startTime"  class="Wdate" style="width:100px;height: 21px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd ',maxDate:'2100'})"/>&nbsp;--</li>
      <li><input name="endTime" type="text" class="Wdate" style="width:100px;height: 21px;" value="${endTime }" onclick="WdatePicker({dateFmt:'yyyy-MM-dd ',minDate:'%y-%M-%d'})"/>&nbsp;</li>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
          	<iamp-identify:IAMPIdentify authid="02_01_05_00">
            ...
            <iamp-identify:IAMPIdentify authid="02_01_06_00">
          ...
          <tbody>
           <c:forEach items="${pageBean.recordList}" var="customer"  varStatus="status">
            <tr class="TableDetail1 template">
				...
				<iamp-identify:IAMPIdentify authid="02_01_03_00">
