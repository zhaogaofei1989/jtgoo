...
<form action="${basePath}/background/VisaProductAction.do?method=list" method="post">
  <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
    <ul class="am-nav am-nav-pills am-topbar-nav" style="margin: 0 0 10px 20px">
      <li>国家分类:&nbsp;<select name="countrySelect" id="countrySelect" style="border-style: solid; border-width: 1px; border-color: #999999">
...
<select name="visaTypeSelect" id="visaTypeSelect" style="border-style: solid; border-width: 1px; border-color: #999999">
<option value="">请选择</option>
...
<select name="lingquSelect" style="border-style: solid; border-width: 1px; border-color: #999999">
<option value="">请选择</option>
<c:forEach items="${lingquList}" var="lingqu">
<option value="${lingqu.id }">${lingqu.name }</option>
</c:forEach>
</select></li>
      <li style="margin-left: 15px">名称/标题:&nbsp;&nbsp;<input type="text" name="visaProductName" id="visaProductName"
      style="border-style: solid; border-width: 1px; border-color: #999999" />&nbsp;</li>
