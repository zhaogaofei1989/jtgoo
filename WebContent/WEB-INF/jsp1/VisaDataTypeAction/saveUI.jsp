...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">签证类别</strong> / <small>${param.id eq null ? '签证类别添加' : '签证类别修改'}</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
      <div class="am-tab-panel am-fade" id="tab2">
        <html:form styleClass="am-form" action="/background/VisaDataTypeAction" styleId="myform">
