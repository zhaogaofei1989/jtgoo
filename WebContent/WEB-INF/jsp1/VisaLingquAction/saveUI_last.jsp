...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${basePath}/style/images/title_arrow.gif"/> 签证领区设置
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <html:form action="/background/VisaLingquAction" styleId="myform">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>前缀</td>
                        <td><html:text property="prefix" styleId="prefix" styleClass="InputStyle"/> *</td>
                    </tr>
                    <tr>
                        <td>分类名称</td>
                        <td><html:text property="name" styleId="name" styleClass="InputStyle"/> *</td>
                    </tr>
                    <tr>
                        <td>所管辖省份</td>
