 ...
 <!-- content start -->
  <div class="admin-content">
   ...
   <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">签证类型管理</strong> / <small>签证类型列表</small></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
         ...
         <iamp-identify:IAMPIdentify authid="03_02_05_00">
            <button type="button" class="am-btn am-btn-default" onclick="createNew('VisaTypeAction.do?method=addUI');"><span class="am-icon-plus"></span> 新增</button>
      ...
      <div class="am-u-sm-12">
          ...
          <tbody>
               <c:forEach items="${visatypeList}" var="visatype">
				...
				<td>
				<iamp-identify:IAMPIdentify authid="03_02_03_00">
					<html:link action="background/VisaTypeAction?method=editUI&id=${visatype.id}">修改</html:link>
				</iamp-identify:IAMPIdentify>
				<iamp-identify:IAMPIdentify authid="03_02_04_00">
