...
<div id="MainArea">
   ...
   <div class="ItemBlock">
    ...
    <c:if test="${param.id ne null}">
     		 <tr>
             <td>产品编号:</td>
             <td><html:text property="serialnumber" readonly="true" styleClass="InputStyle"/></td>
             </tr>
    </c:if>
               ...
               <tr>
            			 <td>签证产品</td>
				            ...
				            #search_divvisa_id li a{  padding-left:6px;displa
 ...
 <td>预定时间:<html:text property="receivedDataTime1" styleClass="Wdate" readonly="true"  onfocus="WdatePicker({startDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm',alwaysUseStartDate:true})"/></td>
          ...
          出发日期:<html:text property="receivedDataTime3" styleClass="Wdate" readonly="true"  onfocus="WdatePicker({startDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm',alwaysUseStartDate:true})"/>
                  <br/>  <br/>
                    操作员: <select name="operator" id="operator" class="SelectStyleSecond" style="width:85px;">
                       ...
                       资料已全:    否:<html:radio property="dataIsComplete"  value="0"/> 是:<html:radio property="dataIsComplete" value="1"/>
  ...
  <tr id="tr_6">
    ...
    <td>已出签</td>
	 ...
	 <th>第八步(${user8 })</th>
	  <td>已寄回</td>
             ...
             <tr id="expressMethod_tr"><td>  快递方式:</td><td><html:text styleId="expressMethod" property="expressMethod" styleClass="InputStyle"/>   </td></tr>
            ...
            <!--  <tr id="passportGetTime_tr"><td>  领取时间:</td><td><html:text styleId="passportGetTime"  styleClass="Wdate" readonly="true" property="passportGetTime"  onfocus="WdatePicker({startDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm',alwaysUseStartDate:true})" />
               ...
               <tr><td>快递公司:</td><td><html:text styleId="express" property="express" styleClass="InputStyle"/></td></tr>
               <tr><td>收件人:</td><td><html:text styleId="expressContact" property="expressContact" styleClass="InputStyle"/></td></tr>
               <tr><td>联系方式:</td><td><html:text styleId="expressContactInformation" property="expressContactInformation" styleClass="InputStyle"/></td></tr>
               <tr><td>快递地址:</td><td><html:text styleId="expressAddress" property="expressAddress" styleClass="InputStyle"/></td></tr>
               </table>
                   </td>
	</tr>      
	<tr id="tr_8">
	<th style="font-size: 12px;">第九步(${user9})</th>
	 <td>已完成</td>
                        <td>上传操作资料: <input type="button" value="上传资料" onclick="upload(${param.id })"/>   
  ...
  <td>
  <table>
  <tr><td>付款金额</td><td><html:text styleId="payForAmount" property="payForAmount" styleClass="InputStyle" /></td></tr>
  <tr><td>付款时间</td><td><html:text property="payForTime" styleClass="Wdate" onfocus="WdatePicker({startDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm',alwaysUseStartDate:true})"/></td></tr>
  </table>
        ...
        <div id="InputDetailBar">
            <input id="save" type="submit" class="cmd" value="保存" onclick="return validate()"/>
            <input type="button" class="cmd" id="saveGoOn"  onclick="return saveAndGoOn();"  value="保存并继续" />
            <input type="button" class="cmd" id="saveAndClose"  onclick="return editAndClose();"  value="保存并关闭" />
            <input type="button" class="cmd" id="next"  onclick="nextOrBack(0)"  value="下一步" />
            <input type="button" class="cmd" id="back" onclick="nextOrBack(1)"  value="上一步" />
        </div>
    </html:form>
</div>
