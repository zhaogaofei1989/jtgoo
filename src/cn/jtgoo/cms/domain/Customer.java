...
public class Customer {
	...
	/**
	 * 用户类型 0代表由后端系统添加的用户 ，1代表 自己注册的用户
	 * 默认是0，
	 */
   ...
   */
	 ...
	 * 同业或者 直接用户与客户的关系
	 */
	private Set<Customer> children = new HashSet<Customer>();
	/**
	 * 资料详情  多对多的关系
	 */
	...
	public Customer getOtherUser() {
		return otherUser;
	}

	public void setOtherUser(Customer otherUser) {
