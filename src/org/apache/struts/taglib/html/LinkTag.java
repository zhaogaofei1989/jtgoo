/*
 * $Id: LinkTag.java 499093 2007-01-23 18:24:41Z niallp $
 *
 ...
 * 
 * @version $Rev: 499093 $ $Date: 2005-04-06 02:37:00 -0400 (Wed, 06 Apr 2005) $
 */
public class LinkTag extends BaseHandlerTag {
	 ...
	 * </p>
	 * <p>
	 * Usage note: If a forward config is used in a hyperlink, and a module is specified, the path must lead to another action and not directly to a
	 * page. This is in keeping with rule that in a modular application all links must be to an action rather than a page.
	 * </p>
	 */
